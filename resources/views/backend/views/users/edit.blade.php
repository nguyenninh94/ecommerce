      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            {!! Form::model($user, array('route' => ['users.update', $user->id],'method'=>'PATCH', 'role' => 'form')) !!}
                    ...
                    <div class="form-group">
                        ...
                        @foreach($roles as $value)
                           <label>{!! Form::checkbox('role[]', $value->id, in_array($value->id, $userRoles) ? "checked" : "") !!} {{$value->name}}</label>
                        @endforeach
                        <br/>
